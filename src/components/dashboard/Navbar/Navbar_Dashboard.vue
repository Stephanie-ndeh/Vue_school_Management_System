...
<ul class="nav user-menu">
   <NotificationsBar />
    <li class="nav-item dropdown has-arrow new-user-menus"> 
        <AdminLogo text="Admin Name" name="Administrator"/> 
    </li>  
...
<script>
import NavbarLeft from '../Navbar/NavbarLeft.vue'
import MenuToggle from '../Navbar/MenuToggle.vue'
import SearchBar from '../Navbar/SearchBar.vue'
import NotificationsBar from '../Navbar/NotificationsBar.vue'
import AdminLogo  from '../Navbar/AdminLogo.vue'
export default {
    name: 'Navbar_Dashboard',
    props: {
      title: String
    },
    components: {
...
.login-wrapper .loginbox .login-left:before {
  content: "";
  background-image: url(../../../assets/login-icon-01.png);
  position: absolute;
  top: 0;
  left: 0;
  width: 144px;
...
.login-wrapper .loginbox .login-left:after {
  content: "";
  background-image: url(../../../assets/login-icon-02.png);
  position: absolute;
  top: 0;
  right: 0;
  width: 144px;
...
.card.comman-shadow {
  background: #fff;
  box-shadow: 0 0 31px rgba(44, 50, 63, 0.02);
  border-radius: 15px;
  border: 0;
}
...
.cd-timeline-navigation a::after {
  ...
  background: url(../../../assets/arrow.svg) no-repeat 0 0;
}
...
@media (min-width: 992px) {
  #toggle_btn {
    ...
    z-index: 99;
    top: 10px;
    box-shadow: 0 0 35px rgba(61, 47, 146, 0.1);
  }
